...
Tasklist single page app built with Laravel & React.js (with Vite.js).

<img src="https://i.imgur.com/ZJMHgBa.gif" style="width: 100%;">
...
- **_[Optional]_** For development, run the following command to watch the assets for changes.
```shell
npm run dev
```
...
- Open the application in a browser at [http://localhost:8000](http://localhost:8000), or your custom URL (e.g. http://tasklist.site).
